...
class BLKGeneratorApp:
    ...
    def _create_widgets(self):
        ...
        self.file_name_entry.insert(0, DEFAULT_FILE_NAME) # Set default value
  ...
  range:p2=32, 32"""
    ...
    def _generate_blk(self):
        ...
        """
        file_name = self.file_name_entry.get().strip() or DEFAULT_FILE_NAME
        save_path = self.settings.get("save_path")
